...
Answer: 
	...
	# timedatectl	(take few seconds to synchronize)

# chronyc sources -v	(system time synchronize information)

	# timedatectl list-timezones
	# timedatectl set-timezone America/Phoenix		(set time zone)
	# timedatectl
	
	#timedatectl set-time 6:00:00		(set time, usually restricted to change time)
